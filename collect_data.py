#to collect the data from ip camera
import cv2
...
url = "http://10.102.25.52:8080/shot.jpg"
...
while len(data) < 100:
    ...
    if len(face_points)>0:
        for x,y,w,h in face_points:
            face_frame = frame[y:y+h+1,x:x+w+1] #this is the face area
    ...
    if cv2.waitKey(30) ==27: #exit on pressing esc key
    # if cv2.waitKey(30) == ord("q"):
        break
cv2.destroyAllWindows() #destroying all opened windows
